...
Components - self contained section of content, like a header, footer, sidebar etc  
...
E.g. if you create a var above the return element of the component function, you cal refer to that var within code brackets.  
You can also do, e.g. cals within curly brackets  
...
If you have pages as separate HTML files, you can call those in your responses - res.sendFile plus path .. but needs a second
...
Referring to the app,js file, you can add data you send into the ejs file, as a second param after naming the page
...
noSQL / collections  
documents are similar to js objects (KVPs)  
